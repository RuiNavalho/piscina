...
CREATE TABLE IF NOT EXISTS `GestGym`.`atividade_epoca` (
  ...
  PRIMARY KEY (`id`, `atividade_id`, `epoca_id`),
  UNIQUE INDEX `un_atividade_epoca` (`epoca_id` ASC, `atividade_id` ASC),
  INDEX `fk_epoca_has_atividade_atividade1_idx` (`atividade_id` ASC),
  INDEX `fk_epoca_has_atividade_epoca1_idx` (`epoca_id` ASC),
  CONSTRAINT `fk_epoca_has_atividade_atividade1`
...
CREATE TABLE IF NOT EXISTS `GestGym`.`tipo_contacto` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `descricao` VARCHAR(20) NOT NULL,
  `sequencia` BIGINT(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `GestGym`.`horario` (
  ...
  `fim` TIME NOT NULL,
  `atividade_epoca_id` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `GestGym`.`nivel` (
  ...
  `sequencia` BIGINT(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_nivel_atividade1_idx` (`atividade_id` ASC),
  CONSTRAINT `fk_nivel_atividade1`
    FOREIGN KEY (`atividade_id`)
    REFERENCES `GestGym`.`atividade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `GestGym`.`relacao` (
  `cliente_id` BIGINT(20) NOT NULL,
  `cliente_id1` BIGINT(20) NOT NULL,
  `tipo_relacao_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`cliente_id`, `cliente_id1`),
  INDEX `fk_cliente_has_cliente_cliente2_idx` (`cliente_id1` ASC),
  INDEX `fk_cliente_has_cliente_cliente1_idx` (`cliente_id` ASC),
...
CREATE TABLE IF NOT EXISTS `GestGym`.`utente_horario` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_utente_has_aula_aula1_idx` (`horario_id` ASC),
  INDEX `fk_utente_has_aula_utente1_idx` (`utente_id` ASC, `id` ASC),
  CONSTRAINT `fk_utente_has_aula_aula1`
    FOREIGN KEY (`horario_id`)
    REFERENCES `GestGym`.`horario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_utente_has_aula_utente1`
