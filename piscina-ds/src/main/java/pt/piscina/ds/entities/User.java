...
@Table(name = "user", catalog = "gestgym")
public class User implements Serializable {
	...
	*/
	...
	@ManyToMany
	@JoinTable(name = "user_role", catalog = "gestgym", joinColumns = { @JoinColumn(name = "user_id") }, inverseJoinColumns = {
	...
	*/
	...
	public User(boolean active, String email, String fullName, String passw, byte[] photo, Timestamp registryDate,
			String salt, List<Allocation> allocations, List<Project> projects, List<Projmanager> projManagers,
			List<Task> tasks, List<Role> roles, List<Skill> skills) {
		this.active = active;
		this.email = email;
		this.fullName = fullName;
		this.passw = passw;
